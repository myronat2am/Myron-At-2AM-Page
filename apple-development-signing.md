...
graph TD
    ...
    Pack -->|9. 執行重簽名| Sign[使用新 Profile 與 憑證 簽名]
    end
...
* **大型企業內測**：使用 **企業帳號**，但現在帳號申請非常困難，蘋果審核標準變得很嚴格。
...
1. 之前有碰過一個帳號，表面上沒被封禁，但怎樣也無法續費，寄信給蘋果也都是無聲卡，帳號也就無法使用了，推測是蘋果沒有明確證據被濫用，但又和其他被封禁賬號關聯上，所以用這種方式軟封。
